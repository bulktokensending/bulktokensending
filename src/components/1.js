...
export class FirstStep extends React.Component {
  constructor(props){
    ...
    this.onChunkChange = this.onChunkChange.bind(this);
...
0x00fC79F38bAf0dE21E1fee5AC4648Bc885c1d774,14546
  ...
  onChunkChange(e) {
    this.tokenStore.setChunk(e.target.value)
  }
  ...
  async onSubmit(e){
    try {
      ...
      if(this.tokenStore.invalid_addresses.length > 0){
        swal({
          title: "There are invalid eth addresses. If you click Next, Bulk Token Sending will remove them from the list.",
        ...
        <div className="content">
          ...
          <Form className="form">
            ...
            <Textarea
              ...
              <label htmlFor="chunk" className="label">Chunk</label>
              <Input disabled={this.web3Store.loading} type="number" validations={[required]} onChange={this.onChunkChange} value={this.tokenStore.arrayLimit} className="input" id="chunk"/>
